  ...
  return (
    <div className='p-1'>
      ...
      <div className='flex justify-between mx-auto text-sm m-1'>
        ...
        <div className='text-center w-1/2'>{data.productName}</div>
      </div>
      <div className='flex justify-between mx-auto text-sm m-1'>
      ...
      <div className='flex justify-between mx-auto text-sm m-1'>
        ...
        <div className='text-center w-1/2'>{data.category || 'ไม่ระบุ'}</div>
      </div>
      <div className='flex justify-between mx-auto text-sm m-1'>
        <div className='bg-gray-200 px-1 w-1/2 border border-white'>สต็อก</div>
        <div className='text-center w-1/2'>{data.stock}</div>
      </div>
