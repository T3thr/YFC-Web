        ...
        <ul className='space-y-1'>
          <li>
            <label className='flex items-center'>
              ...
              />
              <span className='ml-2 text-gray-500'> เมนูแนะนำ </span>
            </label>
          </li>
          <li>
            <label className='flex items-center'>
              ...
              />
              <span className='ml-2 text-gray-500'> เมนูใหม่ </span>
            </label>
          </li>
          <li>
            <label className='flex items-center'>
              ...
              />
              <span className='ml-2 text-gray-500'> ตามสั่ง </span>
            </label>
          </li>
          <li>
            <label className='flex items-center'>
              ...
              />
              <span className='ml-2 text-gray-500'> โปรโมชั่น </span>
            </label>
          </li>
          <li>
            <label className='flex items-center'>
              ...
              />
              <span className='ml-2 text-gray-500'> ลดราคา </span>
            </label>
          </li>
        </ul>
